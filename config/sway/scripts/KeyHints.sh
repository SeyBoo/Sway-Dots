...
" SHIFT E" "KooL Sway Settings Menu" "" \
"" "" "" \
...
"CTRL ALT Del" "Sway Exit" "(NOTE: Sway Will exit immediately)" \
" SHIFT F" "Fullscreen" "Toggles to full screen" \
" CTL F" "Fake Fullscreen" "Toggles to fake full screen" \
" ALT L" "Toggle Tabbed | Stacking Layout" "Sway Layout" \
...
"" "" "" \
"More tips:" "https://github.com/seyboo/Sway-Dots" ""\
