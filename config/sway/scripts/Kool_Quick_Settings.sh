...
# Rofi menu for KooL Sway Quick Settings (SUPER SHIFT E)
# Updated for UserConfigs/configs separation
# NOTE: Animations, Blur toggle, and Overview entries removed (not supported in Sway)

# Modify this config file for default terminal and EDITOR
config_file="$HOME/.config/sway/UserConfigs/01-UserDefaults.conf"
...
# variables
configs="$HOME/.config/sway/configs"
UserConfigs="$HOME/.config/sway/UserConfigs"
rofi_theme="$HOME/.config/rofi/config-edit.rasi"
msg=' ⁉️ Choose what to do ⁉️'
iDIR="$HOME/.config/swaync/images"
scriptsDir="$HOME/.config/sway/scripts"
UserScripts="$HOME/.config/sway/UserScripts"
...
# NOTE: "Choose Sway Animations", "Toggle Blur", and "Desktop Overview" entries
# have been removed — those features have no equivalent in Sway.
menu() {
    cat <<EOF
--- USER CUSTOMIZATIONS ---
Edit User Defaults
